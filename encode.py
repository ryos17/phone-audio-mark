...
def encode_audio(input_path, sample_rate, message=None):
    # Load the audio file
    ...
    torchaudio.save(output_path, watermarked_audio, sample_rate)
...
def main():
    ...
    encode_audio(args.input_path, args.sample_rate, args.message)
